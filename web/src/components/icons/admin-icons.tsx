 ...
 * Custom SVG icons for the admin interface
 */
...
export function DiscIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TheaterIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function FeaturedIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DiagnosticsIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IssuesIcon({ className = '', size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
