...
export const LibraryIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M3 6C3 4.34315 4.34315 3 6 3H8C9.65685 3 11 4.34315 11 6V18C11 19.6569 9.65685 21 8 21H6C4.34315 21 3 19.6569 3 18V6Z"
      stroke="currentColor"
      strokeWidth="2"
    />
    <path
      d="M13.5 3L20.5 4.5V19.5L13.5 21V3Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const PlayIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M8 5.14v14.72a1 1 0 001.5.87l11.38-7.36a1 1 0 000-1.74L9.5 4.27A1 1 0 008 5.14z" />
  </svg>
);
...
export const SkipBackIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M6 4v16a1 1 0 001 1h2a1 1 0 001-1V4a1 1 0 00-1-1H7a1 1 0 00-1 1z" />
    <path d="M14.5 5.27a1 1 0 011.5.87v11.72a1 1 0 01-1.5.87L9 14.87V9.13l5.5-3.86z" />
  </svg>
);
...
export const SkipForwardIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    ...
    className={className}
  >
    <path d="M18 4v16a1 1 0 01-1 1h-2a1 1 0 01-1-1V4a1 1 0 011-1h2a1 1 0 011 1z" />
    <path d="M9.5 5.27A1 1 0 008 6.14v11.72a1 1 0 001.5.87L15 14.87V9.13L9.5 5.27z" />
  </svg>
);
...
export const VolumeMutedIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PlaylistIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M15 6H3M15 12H3M15 18H3M21 12v6a2 2 0 11-2-2V9"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const QueueIcon = ({ className = "", size = 24 }: IconProps) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SparklesIcon = ({ className = "", size = 24 }: IconProps) => (
  ...
  >
    ...
    />
    <path
      d="M19 12l.75 2.25L22 15l-2.25.75L19 18l-.75-2.25L16 15l2.25-.75L19 12zM7 18l.5 1.5L9 20l-1.5.5L7 22l-.5-1.5L5 20l1.5-.5L7 18z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
